function showSection(id) {
    console.log(`I called this function (showSection) from another function (prepareInternalNav) and the id (argument passed to showSection) is ${id}`);
